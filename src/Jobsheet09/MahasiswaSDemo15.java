        ...
        do { 
            ...
            switch (pilih) {
                case 1:
                    ...
                    MahasiswaS15 mhs = new MahasiswaS15(nama, nim, kelas);
                    stack.push(mhs);
                    System.out.printf("Tugas %s berhasil dikumpulkan\n", mhs.nama);
                    break;
                case 2:
                    MahasiswaS15 dinilai = stack.pop();
                    if (dinilai != null) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    MahasiswaS15 bawah = stack.peekBottom();
                    if (bawah != null) {
